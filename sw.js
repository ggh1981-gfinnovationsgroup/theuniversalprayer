...
const PRECACHE_URLS = [
  ...
  '/assets/images/gloria-suprema-hero.svg',
  '/espiritu/',
  '/espiritu/index.html',
  ...
  '/dopamina/index.html',
  '/control-y-confianza/',
  '/control-y-confianza/index.html',
  '/gloria-suprema/',
