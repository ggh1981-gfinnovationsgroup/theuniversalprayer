...
const INTERCESSORS = [
  ...
  { id: 'cabrini',              subdomain: 'cabrini',              chaplet: false, novena: true,  color: '#1b3f7a', short: { es: 'Santa Cabrini', en: 'St. Cabrini'      }, name: { en: 'Saint Frances Xavier Cabrini',         es: 'Santa Francisca Javier Cabrini'           }, specialty: { es: 'Migrantes y esperanza',      en: 'Migrants & hope'             } },
];
