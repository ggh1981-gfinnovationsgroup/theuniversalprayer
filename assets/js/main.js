...
const INTERCESSORS = [
  ...
  { id: 'sanguillermogellone', subdomain: 'sanguillermogellone', chaplet: false, novena: true, color: '#365a2a', short: { es: 'S. Guillermo G.', en: 'St. William G.' }, name: { en: 'Saint William of Gellone', es: 'San Guillermo de Gellone' }, specialty: { es: 'Conversión y vida monástica', en: 'Conversion & monastic life' } },
  { id: 'sanguillermoaquitania', subdomain: 'sanguillermoaquitania', chaplet: false, novena: true, color: '#5a3a2a', short: { es: 'S. Guillermo A.', en: 'St. William A.' }, name: { en: 'Saint William of Aquitaine', es: 'San Guillermo de Aquitania' }, specialty: { es: 'Conversión tardía y humildad', en: 'Late conversion & humility' } },
  ...
  { id: 'cabrini',              subdomain: 'cabrini',              chaplet: true,  novena: true,  color: '#1b3f7a', short: { es: 'Santa Cabrini', en: 'St. Cabrini'      }, name: { en: 'Saint Frances Xavier Cabrini',         es: 'Santa Francisca Javier Cabrini'           }, specialty: { es: 'Migrantes, familias y caridad cristiana', en: 'Migrants, families and Christian charity' } },
  { id: 'saneduardo',           subdomain: 'saneduardo',           chaplet: true,  novena: true,  color: '#27415f', short: { es: 'San Eduardo',   en: 'St. Edward'       }, name: { en: 'Saint Edward the Confessor',           es: 'San Eduardo el Confesor'                  }, specialty: { es: 'Gobernantes, justicia y paz familiar', en: 'Leaders, justice and family peace' } },
];
...
const KEYWORD_MAP = {
  ...
  cabrini:           'cabrini francesca saverio xavier inmigrantes immigrants migrantes migrants migracion migration frontera border familia separada separated family deportacion deportation refugio shelter acogida welcome hospital escuela orphanage orfanato sacred heart sagrado corazon nueva york new york italia italy chicago pobreza pobreza urbana urban poverty dignidad humana human dignity',
  saneduardo:        'eduardo edward confesor confessor rey king inglaterra england westminster abadia abbey justicia justice gobernantes leaders autoridades authority paz peace familia family reconciliacion reconciliation servicio publico public service gobierno government prudencia prudence integridad integrity caridad charity',
  ...
  sanguillermogellone: 'guillermo gellone william gellone conversión conversion guerrero warrior monje monk monasterio monastery carlomagno charlemagne peregrino pilgrim penitencia penance desierto desert retiro retreat vida monastica monastic life',
  sanguillermoaquitania: 'guillermo aquitania william aquitaine duque duke noble nobleman conversion tardia late conversion humildad humility reconciliacion reconciliation penitencia penance misericordia mercy reforma de vida life reform',
