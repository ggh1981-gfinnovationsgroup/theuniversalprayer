...
const INTERCESSORS = [
  ...
  { id: 'sangustavo',          subdomain: 'sangustavo',          chaplet: false, novena: true,  color: '#2a5a3a', short: { es: 'San Gustavo',     en: 'St. Gustavo'      }, name: { en: 'Saint Gustavo',                         es: 'San Gustavo'                              }, specialty: { es: 'Fe y nombre cristiano',      en: 'Faith & Christian name'      } },
  ...
  { id: 'santaselene',         subdomain: 'santaselene',         chaplet: false, novena: true,  color: '#4a3a8a', short: { es: 'Sta. Selene',     en: 'St. Selene'       }, name: { en: 'Saint Selene',                          es: 'Santa Selene'                             }, specialty: { es: 'Fe en la oscuridad',         en: 'Faith in darkness'           } },
  { id: 'sangabriel',          subdomain: 'sangabriel',          chaplet: false, novena: true,  color: '#1a2a8a', short: { es: 'San Gabriel',     en: 'St. Gabriel'      }, name: { en: 'Saint Gabriel the Archangel',           es: 'San Gabriel Arcángel'                    }, specialty: { es: 'Mensajeros y comunicación', en: 'Messengers & communication'  } },
  { id: 'sanaxayacatl',        subdomain: 'sanaxayacatl',        chaplet: false, novena: true,  color: '#1a5a4a', short: { es: 'San Axayacatl',   en: 'St. Axayacatl'    }, name: { en: 'Saint Axayacatl',                       es: 'San Axayacatl'                            }, specialty: { es: 'Fe e identidad indígena',   en: 'Faith & indigenous identity' } },
];
...
const KEYWORD_MAP = {
  ...
  sangustavo:         'gustavo name nombre onomastica name day fe faith bautismo baptism escandinavo scandinavian germanico germanic nordico nordic angel custodio guardian angel maria virgen virgin patrono patron nombre cristiano christian name fidelidad faithfulness sacerdote priest clerigo clergyman biblia bible misionero missionary silencio silence',
  ...
  santaselene:        'selene luna moon noche night oscuridad darkness fe faith duda doubt desolacion desolation esperanza hope silencio silence fidelidad faithfulness oracion prayer sequia dryness reconfortante consoling paz peace alma soul nombre cristiano christian name luz light sombra shadow noche alma dark night of the soul perseverancia perseverance confianza trust',
  ...
  sanaxayacatl:       'axayacatl nahuatl indigena indigenous azteca aztec mexico mesoamerica cara agua face water reflejo reflection cielo sky lago lake bautismo baptism identidad identity herencia heritage inculturacion inculturation pueblo originario native people guadalupe virgen virgen de guadalupe mexico azteca maya fe indigena misionero missionary evangelizacion evangelization nombre indigena indigenous name sincretismo syncretism',
};
