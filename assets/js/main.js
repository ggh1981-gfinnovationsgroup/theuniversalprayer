...
const INTERCESSORS = [
  ...
  { id: 'santagwendolina',   subdomain: 'santagwendolina',   chaplet: false, novena: true,  color: '#1a5a3a', short: { es: 'Sta. Gwendolina', en: 'St. Gwendoline'   }, name: { en: 'Saint Gwendoline',                      es: 'Santa Gwendolina'                         }, specialty: { es: 'Mártir galesa, pureza y fe celta', en: 'Welsh martyr, Celtic faith and purity' } },
    { id: 'sanmaximiliano',    subdomain: 'sanmaximiliano',    chaplet: false, novena: true,  color: '#8a1520', short: { es: 'S. Maximiliano', en: 'St. Maximilian' }, name: { en: 'Saint Maximilian Mary Kolbe',          es: 'San Maximiliano María Kolbe'              }, specialty: { es: 'Consagración y martirio',    en: 'Consecration & martyrdom'    } },
    { id: 'santaangeladefoligno', subdomain: 'santaangeladefoligno', chaplet: false, novena: true,  color: '#6b3aa6', short: { es: 'Sta. Ángela',    en: 'St. Angela'      }, name: { en: 'Saint Angela of Foligno',              es: 'Santa Ángela de Foligno'                  }, specialty: { es: 'Conversión y penitencia',     en: 'Conversion & penance'        } },
    { id: 'santacoleta',       subdomain: 'santacoleta',       chaplet: false, novena: true,  color: '#2859a8', short: { es: 'Sta. Coleta',     en: 'St. Colette'     }, name: { en: 'Saint Colette of Corbie',              es: 'Santa Coleta de Corbie'                   }, specialty: { es: 'Pobreza y reforma',          en: 'Poverty & reform'            } },
